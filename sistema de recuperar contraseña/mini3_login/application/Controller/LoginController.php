...
class LoginController extends Controller
{
    ...
    public function sendRecoveryCode()
    {
        if (isset($_POST["txtCorreoElectronico"]) && trim($_POST["txtCorreoElectronico"] != '')) {
            ...
            if ($user === false) {
                ...
                //actualizar codigo y fecha de recuperacion para ser enviado
                //trae como respuesta OK o ERROR
    ...
    //PAGINA DONDE VA CAER EL DOCIDOG PARA VALIDAD SU VEHA DE EXPEIRACION
    // Y SER REENVIADO AL FORMULARIO UPDATE PASSWORD
    ...
    //CODIGO  PARA ACTUALIZAR CONSTRASEÑA EN EL FORMULARIO ENVIADO POR CORREO

...
<div class="limiter">
    <div class="container-login100">
        ...
        <div class="wrap-login100 p-t-85 p-b-20">
            <span class="login100-form-title p-b-70" style="margin-bottom: 30px;">
            ...
            <form class="login100-form validate-form" role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="wrap-input100 validate-input m-t-85 m-b-35 dni" data-validate="Ingrese DNI" style="margin-bottom: 30px;">
                    ...
                    <button type="button" id="consultar" class="btn btn-primary btn-xs consultar" style="float: right;background-color: #81172D;">
                        Consultar
                    </button>
                </div>

    ...
    <div class="container-login100">
        ...
        <div class="wrap-login100 p-t-85 p-b-20">
            ...
            <form class="login100-form validate-form" role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate="Ingrese Usuario" style="margin-bottom: 50px;">
                    <input class="input100" type="text" name="username">
                    <span class="focus-input100" data-placeholder="COP"></span>
                </div>

                <div class="wrap-input100 validate-input m-b-50" data-validate="Ingrese Contraseña" style="margin-bottom: 50px;">
                ...
                <ul class="login-more p-t-150" style="margin-top: 70px;">
                    ...
                    <li>
                        ...
                        <a href="registro-obstetra" class="txt2">
                            Registrese
                        </a>
